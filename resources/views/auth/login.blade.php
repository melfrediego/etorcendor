                        ...
                        <div class="m-stack__item m-stack__item--fluid">
                            <div class="m-login__wrapper">
                                <div class="m-login__logo">
                                    <a href="#">
                                        <img src="{{ url('assets/app/media/img/logos/logo_login.png') }}" width="80">
                                    </a>
                                </div>
                                ...
                                <div class="m-login__signin">
                                    ...
                                    <form method="POST" action="{{ route('login') }}">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <!-- <div class="col-md12"> -->
                                                <input id="email" type="email" class="form-control @error('email') is-invalid @enderror col-md12" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>
                                        ...
                                        <div class="form-group row">
                                            <label for="password" class="col-form-label text-md-left">{{ __('Senha') }}</label>
                                        ...
                                        <div class="form-group row mb-0">
                                            <div class="col-md offset-md-4">
                                                <button type="submit" class="btn btn-primary btn-sm m-btn m-btn--custom m-btn--air">
                                                    {{ __('Acessar') }}
                                                </button>
                ...
                <div class="m-grid__item m-grid__item--fluid m-grid m-grid--center m-grid--hor m-grid__item--order-tablet-and-mobile-1  m-login__content" style="background-image: url({{ url('assets/app/media/img/bg/bg-4.jpg') }})">
                    <div class="m-grid__item m-grid__item--middle">
                        <h3 class="m-login__welcome">
                           <!-- App App Reprografia -->
                           River A.C - Sócio Eterno Campeão
                        </h3>
                        <p class="m-login__msg">
                            Area restrita sistema administrativo
                            <!-- <br>
