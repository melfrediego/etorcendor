...
@section('content')
    <div class="m-portlet">
        ...
        <form class="m-form m-form--fit m-form--label-align-right" method="post" action="{{ route('faq.update',$faq->id) }}" enctype="multipart/form-data">
            @csrf
            <div class="m-portlet__body">
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-10">
                        <input class="form-control m-input" type="text" name="pergunta" value="{{$faq->pergunta}}" id="example-text-input">
                    </div>
                </div>
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-10">
                        <input class="form-control m-input" type="text" name="resposta" value="{{$faq->resposta}}" id="example-search-input">
                    </div>
                </div>
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-10">
                        <div class="m-radio-inline">
                            <label class="m-radio">
                                <input type="radio" name="visivel_home" value="S" {{ $faq->visivel_home == 'S' ? 'checked' : '' }}>
                                Sim
                                <span></span>
                            </label>
                            <label class="m-radio">
                                <input type="radio" name="visivel_home" value="N" {{ $faq->visivel_home == 'N' ? 'checked' : '' }}>
                                Não
                                <span></span>
                            </label>
                        </div>
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-10">
                        <div class="m-radio-inline">
                            <label class="m-radio">
                                <input type="radio" name="ativo" value="1" {{ $faq->ativo == true ? 'checked' : '' }}>
                                Sim
                                <span></span>
                            </label>
                            <label class="m-radio">
                                <input type="radio" name="ativo" value="0" {{ $faq->ativo == false ? 'checked' : '' }}>
                                Não
                                <span></span>
                            </label>
                        </div>
