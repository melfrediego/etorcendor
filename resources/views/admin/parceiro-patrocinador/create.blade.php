...
@section('content')
    <div class="m-portlet">
        ...
        <form class="m-form m-form--fit m-form--label-align-right" method="post" action="{{ route('parceiro-patrocinador.store') }}" enctype="multipart/form-data">
            @csrf
            <div class="m-portlet__body">
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-6">
                        <input class="form-control m-input" type="text" name="nome_razao_social" id="example-search-input">
                    </div>
                </div>
                <div class="form-group m-form__group row">
                    <label for="example-search-input" class="col-1 col-form-label">
                    ...
                    <div class="col-6">
                        <input class="form-control m-input" type="email" name="email" id="example-search-input">
                    </div>
                </div>
                <div class="form-group m-form__group row">
                    <label for="example-search-input" class="col-1 col-form-label">
                    ...
                    <div class="col-6">
                        <input class="form-control m-input" type="text" name="site" id="example-search-input">
                    </div>
                </div>
                <div class="form-group m-form__group row">
                    <label for="example-search-input" class="col-1 col-form-label">
                    ...
                    <div class="col-6">
                        <input class="form-control m-input" type="text" name="responsavel_nome" id="example-search-input">
                    </div>
                </div>
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-6">
                        <input class="form-control m-input" type="email" name="responsavel_email" id="example-search-input">
                    </div>
                </div>
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-4">
                        <input class="form-control m-input" type="text" name="responsavel_telefone" id="example-search-input">
                    </div>
                </div>
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-10">
                        <div class="m-radio-inline">
                            <label class="m-radio">
                                <input type="radio" name="patrocinador" value="1">
                                Sim
                                <span></span>
                            </label>
                            <label class="m-radio">
                                <input type="radio" name="patrocinador" value="0">
                                Não
                                <span></span>
                            </label>
                        </div>
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-10">
                        <div class="m-radio-inline">
                            <label class="m-radio">
                                <input type="radio" name="parceiro" value="1">
                                Sim
                                <span></span>
                            </label>
                            <label class="m-radio">
                                <input type="radio" name="parceiro" value="0">
                                Não
                                <span></span>
                            </label>
                        </div>
