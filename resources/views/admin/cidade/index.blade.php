        ...
        <div class="m-portlet__head-tools">
            <ul class="m-portlet__nav">
                <li class="m-portlet__nav-item">
                    <a href="/faq" class="m-portlet__nav-link btn btn-brand m-btn m-btn--icon m-btn--icon-only btn-sm btn-metal">
                        <i class="fa fa-refresh"></i>
                    </a>
                </li>
                <li class="m-portlet__nav-item">
                    <a href="/faq/create" class="m-portlet__nav-link btn btn-brand m-btn m-btn--icon-only btn-sm btn-info">
    ...
    <div class="m-portlet__body">
        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <form action="{{route('faq.search')}}" method="POST" class="form-group form-inline">
                    @csrf
                    ...
                    <div class="input-group-append">
                        ...
                        &nbsp;
                        <a href="/faq" class="btn btn-default btn-sm">
                ...
                <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        @forelse ($itens as $key => $item)
                          <tr>
                              <td>{{ $item->id }}</td>
                              <td>{{str_limit($item->pergunta, $limit = 70, $end = '...')}}</td>
                              <td>{{str_limit($item->resposta, $limit = 70, $end = '...')}}</td>
                              <td width="130" class="text-center">
                                  @if ($item->visivel_home == 'S')
                              ...
                              <td width="160">
                                  <a href="{{ route('faq.show',$item->id) }}" class="btn btn-primary m-btn m-btn--icon btn-sm m-btn--icon-only" data-skin="dark" data-toggle="m-tooltip" data-placement="top" title="" data-original-title="Ver dados"><i class="fa fa-search"></i></a>
                                  <a href="{{ route('faq.edit',$item->id) }}" class="btn btn-sm btn-info" data-skin="dark" data-toggle="m-tooltip" data-placement="top" title="" data-original-title="Editar dados"><i class="fa fa-edit"></i></a>
                        ...
                        @empty
                            <h2 class="text-center">Nenhum FAQ Cadastrado</h2>
                        @endforelse
