        ...
        <div class="m-portlet__head-tools">
            <ul class="m-portlet__nav">
                <li class="m-portlet__nav-item">
                    <a href="/plano" class="m-portlet__nav-link btn btn-brand m-btn m-btn--icon m-btn--icon-only btn-sm btn-metal">
                        <i class="fa fa-refresh"></i>
                    </a>
                </li>
                <li class="m-portlet__nav-item">
                    <a href="/plano/create" class="m-portlet__nav-link btn btn-brand m-btn m-btn--icon-only btn-sm btn-info">
    ...
    <div class="m-portlet__body">
        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <form action="{{route('plano.search')}}" method="POST" class="form-group form-inline">
                    @csrf
                    ...
                    <div class="input-group-append">
                        ...
                        &nbsp;
                        <a href="/plano" class="btn btn-default btn-sm">
                ...
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                        ...
                        @forelse ($itens as $key => $item)
                          <tr>
                              <td>{{ $item->id }}</td>
                              <td>{{str_limit($item->nome, $limit = 70, $end = '...')}}</td>
                              <td>{{str_limit($item->titulo, $limit = 70, $end = '...')}}</td>
                              <td>{{ $item->valor }}</td>
                              ...
                              <td width="160">
                                  <a href="{{ route('plano.show',$item->id) }}" class="btn btn-primary m-btn m-btn--icon btn-sm m-btn--icon-only" data-skin="dark" data-toggle="m-tooltip" data-placement="top" title="" data-original-title="Ver dados"><i class="fa fa-search"></i></a>
                                  <a href="{{ route('plano.edit',$item->id) }}" class="btn btn-sm btn-info" data-skin="dark" data-toggle="m-tooltip" data-placement="top" title="" data-original-title="Editar dados"><i class="fa fa-edit"></i></a>
                        ...
                        @empty
                            <h2 class="text-center">Nenhum Plano Cadastrado!</h2>
                        @endforelse
...
<script type="text/javascript">
    ...
    {
        var id = id;
        var url = '{{ route("plano.destroy", ":id") }}';
