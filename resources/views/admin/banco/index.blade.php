        ...
        <div class="m-portlet__head-tools">
            <ul class="m-portlet__nav">
                <li class="m-portlet__nav-item">
                    <a href="/banco" class="m-portlet__nav-link btn btn-brand m-btn m-btn--icon m-btn--icon-only btn-sm btn-metal">
                        <i class="fa fa-refresh"></i>
                    </a>
                </li>
                <li class="m-portlet__nav-item">
                    <a href="/banco/create" class="m-portlet__nav-link btn btn-brand m-btn m-btn--icon-only btn-sm btn-info">
    ...
    <div class="m-portlet__body">
        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <form action="{{route('banco.search')}}" method="POST" class="form-group form-inline">
                    @csrf
                    ...
                    <tbody>
                        ...
                        @forelse ($itens as $key => $item)
                          <tr>
                              ...
                              <td width="140">
                                  {{-- <a href="{{ route('banco.show',$item->id) }}" class="btn btn-primary m-btn m-btn--icon btn-sm m-btn--icon-only" data-skin="dark" data-toggle="m-tooltip" data-placement="top" title="" data-original-title="Ver dados"><i class="fa fa-search"></i></a> --}}
                                  <a href="{{ route('banco.edit',$item->id) }}" class="btn btn-sm btn-info" data-skin="dark" data-toggle="m-tooltip" data-placement="top" title="" data-original-title="Editar dados"><i class="fa fa-edit"></i></a>
                        ...
                        @empty
                            <h2 class="text-center">Nenhum Banco Cadastrado</h2>
                        @endforelse
...
<script type="text/javascript">
    ...
    {
        var id = id;
        var url = '{{ route("banco.destroy", ":id") }}';
