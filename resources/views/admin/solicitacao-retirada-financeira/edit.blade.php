...
@section('content')
    <div class="m-portlet">
        ...
        <form class="m-form m-form--fit m-form--label-align-right" method="post" action="{{ route('banco.update',$banco->id) }}" enctype="multipart/form-data">
            @csrf
            <div class="m-portlet__body">
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-10">
                        <input class="form-control m-input" type="text" name="numero" value="{{$banco->numero}}" id="example-text-input">
                    </div>
                </div>
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-10">
                        <input class="form-control m-input" type="text" name="nome" value="{{$banco->nome}}" id="example-search-input">
                    </div>
                </div>
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-10">
                        <div class="m-radio-inline">
                            <label class="m-radio">
                                <input type="radio" name="ativo" value="1" {{ $banco->ativo == true ? 'checked' : '' }}>
                                Sim
                                <span></span>
                            </label>
                            <label class="m-radio">
                                <input type="radio" name="ativo" value="0" {{ $banco->ativo == false ? 'checked' : '' }}>
                                Não
                                <span></span>
                            </label>
                        </div>
